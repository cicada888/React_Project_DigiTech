...
(function($) {
    ...
    $.fn.aws_search = function(options) {
        var methods = {
            init: function() {
                var appendResultsTo = AwsHooks.apply_filters("aws_results_append_to", "body", {
                    instance: instance,
                    form: self,
                    data: d
                });
            ...
            ajaxRequest: function() {
                ...
                data = AwsHooks.apply_filters("aws_ajax_request_params", data, {
                    instance: instance,
                    form: self,
                    data: d
                });
            ...
            showResults: function(response) {
                ...
                html += "</ul>";
                html = AwsHooks.apply_filters("aws_results_html", html, {
                    response: response,
                    data: d
                });
                methods.hideLoader();
            ...
            onFocus: function(event) {
                var show = AwsHooks.apply_filters("aws_show_modal_layout", false, {
                    instance: instance,
                    form: self,
                    data: d
                });
            ...
            hideResults: function(event) {
                if (!$(event.target).closest(".aws-container").length && !$(event.target).closest(self).length && !$(event.target).closest(d.resultBlock).length) {
                    methods.resultsHide()
                }
            },
            ...
            resultLayout: function() {
                ...
                var forcePosition = AwsHooks.apply_filters("aws_results_force_position", false, {
            ...
            getResultsBlockHeight: function() {
                ...
                var resultsHeight = $resultsBlock.height();
                if (resultsHeight === 0) {
                    var copied_elem = $resultsBlock.clone().attr("id", false).css({
                        visibility: "hidden",
                        display: "block",
                        position: "absolute"
                    });
        ...
        var d = self.data(pluginPfx);
        methods.createAndDispatchEvent(document, "awsLoaded", {
            instance: instance,
            form: self,
            data: d
        });
