        ...
        function showFilterSliderArrow() {
            ...
            $(".calendar_main:not([class^='ecwd_widget'] .calendar_main) .ecwd_calendar_view_tabs").each(function(key, element) {
                ...
                if (ecwd_calendar_view_visible_count <= li_position && li_position != 0) {
                    $(element).find('ul li').css({
                        left: "-" + ((li_position + 1 - ecwd_calendar_view_visible_count) * ecwd_view_item_width) + "px"
                    });
            ...
            $('.ecwd_calendar_view_tabs .filter-arrow-right').click(function() {
                ...
                if (click && view_filter_container_width < view_filter_width * view_filter_count && parseInt($(this).parent().find('ul li').css('left')) >= -(view_filter_width * (view_filter_count) - view_filter_container_width)) {
                    click = 0;
                    $(this).parent().find('ul li').animate({
                        left: "-=" + view_filter_width
                    }, 400, function() {
                        click = 1
                    });
                }
        ...
        function upcomingEventsSlider() {
            ...
            jQuery('.upcoming_events_slider .upcoming_events_slider-arrow-right').click(function() {
                ...
                if (click && upcoming_events_slider_main < events_item_width * events_item_count && parseInt(jQuery(this).parent().find('ul li').css('left')) >= -(events_item_width * (events_item_count) - upcoming_events_slider_main)) {
                    click = 0;
                    jQuery(this).parent().find('ul li').animate({
                        left: "-=" + events_item_width
                    }, 400, function() {
                        click = 1
                    });
                }
                ...
                if (!main_div) {
                    ...
                    if (main_div.find(".ecwd_calendar").hasClass('ecwd-widget-mini') === false) {
                        if (main_div.find(".ecwd_show_filters span").hasClass('open')) {
                            main_div.find(".ecwd_calendar").css({
                                "max-width": "71%",
                                "float": "left"
                            });
                            main_div.find(".ecwd_filters").css({
                                "max-width": "27%",
                                "width": "27%",
                                "float": "left"
                            });
                            ...
                            events: {
                                click: function(marker, event, context) {
                                    var map = jQuery(maps[k]).gmap3("get"),
                                        infowindow = jQuery(maps[k]).gmap3({
                                            get: {
                                                name: "infowindow"
                                            }
                                        });
